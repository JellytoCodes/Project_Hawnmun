...
private :
	...
	AHawnmunEnemy* GetNearestTargetFromAvailableActors(const TArray<AHawnmunEnemy*>& InAvailableActors);
	void GetAvailableActorsAroundTarget(TArray<AHawnmunEnemy*>& OutActorsOnLeft, TArray<AHawnmunEnemy*>& OutActorsOnRight);
...
#pragma endregion
	...
	UPROPERTY()
	TArray<AHawnmunEnemy*> AvailableActorsToLock;

	UPROPERTY()
	AHawnmunEnemy* CurrentLockedActor;
