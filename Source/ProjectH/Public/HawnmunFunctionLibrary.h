...
#pragma region Gameplay Mechanics
	...
	UFUNCTION(BlueprintCallable, Category = "Hawnmun|SaveLoad")
	static void InitializeAttributesFromSaveData(const UObject* WorldContextObject, UAbilitySystemComponent* ASC, UHawnmunSaveGame* SaveGame);
#pragma endregion
