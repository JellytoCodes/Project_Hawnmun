...
template<class UserClass, typename PressedFuncType, typename ReleasedFuncType>
void UHawnmunEnhancedInputComponent::BindAbilityActions(const UDataAsset_InputConfig* InputConfig, UserClass* Object, PressedFuncType PressedFunc, ReleasedFuncType ReleasedFunc)
{
	check(InputConfig);
